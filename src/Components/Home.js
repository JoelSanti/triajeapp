...
const Home = () => {
  return (
    <div className="h-screen md:pt-28 bg-gradient-to-r from-cyan-500 to-blue-500 py-4">
      <div className="flex flex-row flex-wrap justify-center items-center w-11/12  md:w-10/12 border-2 border-double border-cyan-200 relative mx-auto p-4 h-full md:p-8 md:h-5/6  rounded-2xl shadow-xl bg-slate-50">
